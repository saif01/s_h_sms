                        ...
                        <v-window-item value="basic">
                            <div class="pa-4">
                                <v-text-field v-model="form.name" variant="outlined" :rules="[rules.required]" required
                                    hint="Enter the customer's full name" :error-messages="getFieldError('name')"
                                ...
                                <v-text-field v-model="form.code" label="Code" variant="outlined"
                                    ...
                                    hint="Auto-generated from name, but can be edited. Unique identifier for the customer"
                                ...
                                <v-switch v-model="form.is_active" label="Active" color="success"
                                    hint="Enable to make this customer active. Inactive customers won't appear in some lists"
                        ...
                        <v-window-item value="contact">
                            <div class="pa-4">
                                <v-text-field v-model="form.email" label="Email" type="email" variant="outlined"
                                    ...
                                    hint="Optional: Enter the customer's email address for communication"
                        ...
                        <v-window-item value="financial">
                            <div class="pa-4">
                                <v-text-field v-model.number="form.opening_balance" label="Opening Balance"
                                    ...
                                    hint="Enter the initial balance when creating this customer. Must be 0 or greater"
                                ...
                                <v-textarea v-model="form.notes" label="Notes" variant="outlined" rows="4"
                                    hint="Optional: Add any additional notes or comments about this customer"
...
export default {
    ...
    watch: {
        ...
        dialogModel(newValue) {
            if (newValue && !this.editingCustomer) {
                // Generate code when dialog opens for new customer
                this.$nextTick(() => {
    ...
    methods: {
        ...
        async onSave() {
            ...
            try {
                ...
                // Get customer ID from the customer prop (editingCustomer is a boolean computed property)
                const customerId = this.customer?.id;
                if (this.editingCustomer && !customerId) {
                    throw new Error('Customer ID is missing. Cannot update customer.');
                }
                ...
                this.$emit('save', { data: this.form, isEditing: !!customerId });
            } catch (error) {
